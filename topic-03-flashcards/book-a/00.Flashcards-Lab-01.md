...
In this workshop you will create a **Flashcard** that's intuitive in relation to content you may have covered in class, the flashcard will have images that the user has to pair with questions and answers in the activity.
...
3. Submit both the H5P component you just created in these workshop labs and the document you created in step 1 to the assignment <a href="http://conorpaul.com/moodle35/course/view.php?id=9#section-3" target="_blank">submission area</a> in Moodle.
